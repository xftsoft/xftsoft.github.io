$(function () {
    ...
    //PC端首页
        ...
        if (!$("#banner1").hasClass('animate__backInLeft')) {
            $("#banner1").addClass('animate__backInLeft');
        }
        if (!$("#banner2").hasClass('animate__backInRight')) {
            $("#banner2").addClass('animate__backInRight');
        }
